...
<div>
  ...
  <span className="text-sm font-semibold text-slate-900 sm:text-xs sm:leading-5 sm:text-slate-700">
    {dictionary.payoutMethods[provider.payoutMethod]}
  </span>
