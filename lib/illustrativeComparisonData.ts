...
const common = {
  A: { providerName: "Provider A", deliveryLabel: "Same day", deliveryRank: 3, payoutMethod: "Cash or bank", badge: "Best Value", accent: "emerald" },
  B: { providerName: "Provider B", deliveryLabel: "1–2 business days", deliveryRank: 4, payoutMethod: "Bank deposit", badge: "Lowest Fee", accent: "blue" },
  C: { providerName: "Provider C", deliveryLabel: "Near instant", deliveryRank: 1, payoutMethod: "Cash pickup", badge: "Fastest", accent: "amber" },
  D: { providerName: "Provider D", deliveryLabel: "Within an hour", deliveryRank: 2, payoutMethod: "Mobile wallet", badge: "Wallet Delivery", accent: "violet" },
} as const;
